...
public class PlaneService {
    ...
    * */
    ...
    public void upsertPlaneData(JsonNode jsonPlaneData, String searchDate) {
        ...
        List<Plane> toSave = processPlaneItems(jsonPlaneData, existPlaneDbMap, searchDate);
     ...
     */
    private List<Plane> processPlaneItems(JsonNode items, Map<String, Plane> existPlaneDbMap, String searchDate) {
