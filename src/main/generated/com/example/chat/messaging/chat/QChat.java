...
public class QChat extends EntityPathBase<Chat> {
    ...
    public final com.example.chat.messaging.chatRoom.QChatRoom chatRoom;
    ...
    public QChat(Class<? extends Chat> type, PathMetadata metadata, PathInits inits) {
        ...
        this.chatRoom = inits.isInitialized("chatRoom") ? new com.example.chat.messaging.chatRoom.QChatRoom(forProperty("chatRoom"), inits.get("chatRoom")) : null;
